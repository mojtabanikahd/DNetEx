...
def get_metrics_values(metric_hist):
    ...
    fdr_sd = column_sd_ignore_none(fdr_hist)
    recall_sd = column_sd_ignore_none(recall_hist)
    return tpr_mean, fpr_mean, precision_mean, recall_mean, fdr_mean, q_mean, time_mean, time_sd, fdr_sd, recall_sd
...
def extract_metrics(metric_list):
    ...
    for i in range(len(metric_list)):
        ...
        tpr_hist_mean, fpr_hist_mean, precision_hist_mean, recall_hist_mean, fdr_hist_mean, qs_hist_mean, time_hist_mean, time_hist_sd, fdr_hist_sd, recall_hist_sd = get_metrics_values(metric_list_hist)
        ...
        fdr_list_sd.append(fdr_hist_sd)
        recall_list_sd.append(recall_hist_sd)
    metrics = [precision_list, recall_list, fdr_list, qs_list, time_list_mean, time_list_sd, fdr_list_sd, recall_hist_sd]
    return metrics
